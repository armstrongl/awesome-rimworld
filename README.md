# Awesome RimWorld [![Awesome](https://awesome.re/badge.svg)](https://awesome.re) [![Lint](https://github.com/armstrongl/awesome-RimWorld/actions/workflows/lint.yml/badge.svg)](https://github.com/armstrongl/awesome-RimWorld/actions/workflows/lint.yml)

> A curated list of awesome RimWorld mods, tools, and resources.

[RimWorld](https://rimworldgame.com/) is a sci-fi colony survival simulator by Ludeon Studios. This list focuses on resources for players seeking to enhance their gameplay through mods, tools, and community resources.

**DLC Labels:** Items marked with 🏛️ require Royalty, 📿 require Ideology, 🧬 require Biotech, or 👁️ require Anomaly.
...
Official RimWorld resources from Ludeon Studios.

- [Ludeon Studios](https://ludeon.com/) - The developer of RimWorld.
- [RimWorld Steam Store](https://store.steampowered.com/app/294100/RimWorld/) - Official Steam page for purchasing RimWorld.
- [RimWorld Wiki](https://rimworldwiki.com/) - Community-maintained wiki with comprehensive game documentation.
...
Core libraries and frameworks required by many mods.

- [Harmony](https://github.com/pardeike/Harmony) - The essential patching library that most RimWorld mods depend on.
- [HugsLib](https://steamcommunity.com/sharedfiles/filedetails/?id=818773962) - Shared library providing common functionality for many mods.
- [Vanilla Expanded Framework](https://steamcommunity.com/sharedfiles/filedetails/?id=2023507013) - Required framework for all Vanilla Expanded mods with shared features like custom factions and building exports.
- [XML Extensions](https://steamcommunity.com/sharedfiles/filedetails/?id=2574315206) - Extends XML modding with new patch operations, mod settings creation, and enhanced error reporting.

## Quality of Life

Mods that improve the day-to-day experience of playing RimWorld.

- [Allow Tool](https://steamcommunity.com/sharedfiles/filedetails/?id=761421485) - Adds mass allow/forbid tools, priority hauling, and batch commands for hunting, harvesting, and more.
- [Animals Logic](https://steamcommunity.com/sharedfiles/filedetails/?id=1098354593) - Enhances animal management with production info displays, medical alerts, and features like nutrient paste dispensers for animals.
- [Auto Ability](https://steamcommunity.com/sharedfiles/filedetails/?id=3578731212) - Automatically activates pawn abilities based on configurable conditions.
- [Auto Conduits](https://steamcommunity.com/sharedfiles/filedetails/?id=3423393846) - Enables flood-fill placement of conduits by holding Shift and clicking on walls.
- [Auto Links](https://steamcommunity.com/sharedfiles/filedetails/?id=2059389912) - Automatically adds hyperlinks in item descriptions connecting recipes, ingredients, and research.
...
- [RimFridge](https://steamcommunity.com/sharedfiles/filedetails/?id=2898411376) - Adds refrigerated storage units that keep food and perishables cold with shelf support.
- [RIMMSqol](https://steamcommunity.com/sharedfiles/filedetails/?id=1084452457) - Over 1,000 editable game properties, character editing, and UI customizations through an in-game interface.
- [RimSaves](https://steamcommunity.com/sharedfiles/filedetails/?id=1713367505) - Enhances save menu with previews, folder organization, and quicksave functionality.
- [Smart Farming Continued](https://steamcommunity.com/sharedfiles/filedetails/?id=3220129183) - Extra tools for grow zones including sowing predictions, prioritization, and harvest automation.
- [Smart Medicine - Continued](https://steamcommunity.com/sharedfiles/filedetails/?id=3526251680) - Doctors access medicine from patient inventories, carry supplies, and use minimal medicine for minor injuries.
- [Smart Speed](https://steamcommunity.com/sharedfiles/filedetails/?id=1504723424) - Unlocks ultra-fast game speeds and custom multipliers with separate event speed settings.
- [Smarter Construction](https://steamcommunity.com/sharedfiles/filedetails/?id=2202185773) - Prevents pawns from building themselves into walls or blocking unfinished structures.
- [Smarter Visitors](https://steamcommunity.com/sharedfiles/filedetails/?id=3012491521) - Visitors delay departure when dangers like raids or health issues are present.
- [Social Experience from Trade](https://steamcommunity.com/sharedfiles/filedetails/?id=3400608063) - Colonists gain social skill experience when trading.
- [Stack XXL](https://steamcommunity.com/sharedfiles/filedetails/?id=826366050) - Configurable stack size multipliers to reduce storage space requirements.
...
Mods that improve game performance, especially for large colonies and mod lists.
...
Mods that enhance the user interface and information display.
...
- [Numbers](https://steamcommunity.com/sharedfiles/filedetails/?id=1414302321) - Adds spreadsheet-like colonist overview with sortable columns for stats.
- [Prisoner Management Panel](https://steamcommunity.com/sharedfiles/filedetails/?id=3523828989) - Centralized panel for managing all prisoners with batch operations.
...
Mods that overhaul or enhance RimWorld's combat system.

- [Avoid Friendly Fire](https://steamcommunity.com/sharedfiles/filedetails/?id=1134165362) - Colonists avoid shooting when allies are in the line of fire.
- [Combat Extended](https://steamcommunity.com/sharedfiles/filedetails/?id=1631756268) - Comprehensive combat overhaul with ammunition, armor penetration, and realistic ballistics.
- [RunAndGun](https://steamcommunity.com/sharedfiles/filedetails/?id=3523879860) - Allows pawns to fire ranged weapons while moving.
- [Search and Destroy (Continued)](https://steamcommunity.com/sharedfiles/filedetails/?id=3232242247) - Toggle mode for drafted pawns to automatically hunt down enemies.
- [Yayo's Combat](https://steamcommunity.com/sharedfiles/filedetails/?id=2038409475) - Lighter combat overhaul with new animations and optional ammo system.

## Vanilla Expanded

The Vanilla Expanded series expands RimWorld while maintaining vanilla art style and balance. All require the Vanilla Expanded Framework (see Framework Mods section above).

- [Vanilla Expanded Collection](https://steamcommunity.com/workshop/filedetails/?id=1884025115) - Official Steam collection of all Vanilla Expanded mods.
- [Vanilla Expanded Wiki](https://rimworld-ve.fandom.com/) - Community wiki documenting all Vanilla Expanded content.
- [Vanilla Factions Expanded](https://steamcommunity.com/sharedfiles/filedetails/?id=2353686365) - Adds new factions including Settlers, Medieval, Vikings, Insectoids, and more.
- [Vanilla Furniture Expanded](https://steamcommunity.com/sharedfiles/filedetails/?id=1718190143) - Adds diverse furniture options for building varied colonies.
- [Vanilla Psycasts Expanded](https://steamcommunity.com/sharedfiles/filedetails/?id=2842502659) - Massive expansion of the psycasts system with new paths and abilities. 🏛️
- [Vanilla Races Expanded](https://steamcommunity.com/sharedfiles/filedetails/?id=2871665628) - Adds new xenohuman races with unique genes and mechanics. 🧬
- [Vanilla Weapons Expanded](https://steamcommunity.com/sharedfiles/filedetails/?id=1814383360) - Adds new weapons including makeshift, laser, and persona weapon modules.

## Content Expansion

Major mods that add significant new content or mechanics.
...
Curated collections for players who want a pre-built mod experience.

- [Rimworld Enhanced (1.6, No Bloat)](https://steamcommunity.com/sharedfiles/filedetails/?id=3021449381) - QoL and content improvements without excessive load times.
- [RimWorld Ultimate Collection](https://steamcommunity.com/sharedfiles/filedetails/?id=2976993124) - Extensively curated collection from a 3500+ hour player.
- [Vanilla Friendly Combat Overhaul](https://steamcommunity.com/workshop/filedetails/?id=1985947759) - Combat mods that work together without compatibility issues.

## Modding Resources

Resources for creating RimWorld mods.

- [RimWorld Modding Resources](https://spdskatr.github.io/RWModdingResources/) - Community-collated hub for modding tools, tutorials, and references.
- [RimWorld Modding Tutorials](https://rimworldwiki.com/wiki/Modding_Tutorials) - Official wiki tutorials for XML, C#, and mod creation basics.
- [RimWorld XML Auto-Documentation](https://github.com/Vanilla-Expanded/VanillaExpandedFramework) - Reference for all vanilla Def types and their fields.
...
Other awesome lists and resources that complement this one.

- [Awesome Game Development](https://github.com/ellisonleao/magictools) - Resources for game development in general.
- [Awesome Unity](https://github.com/RyanNielson/awesome-unity) - Resources for Unity development (RimWorld's engine).
